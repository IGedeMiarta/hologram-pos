...
<body class="c-app flex-row align-items-center" style="background-color: black">
    <div class="container">
        <div class="row mb-3">
        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <p class="text-center mt-5 lead">
                    Developed By
                    <a href="https://igedemiarta.github.io/" class="font-weight-bold text-primary">IGede Miarta</a>
                </p>
            </div>
        </div>
    </div>
